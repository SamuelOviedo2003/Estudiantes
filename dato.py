...
class Dato:
    ...
    def __str__(self):
        return f'Objeto Dato=[nombre: {self.nombre}, edad: {self.edad}, sexo:{self.sexo},departamento:{self.departamento},municipio:{self.municipio},nivel_Educativo:{self.nivel_Educativo},anos_Actual:{self.anos_Actual}]'
