...
Antioquia=["Abejorral","Abriaquí","Alejandría","Amagá","Amalfi","Andes","Angelópolis","Angostura","Anorí","Anzá","Apartadó","Arboletes","Argelia","Armenia","Barbosa","Bello","Belmira","Betania","Betulia","Briceño","Buritcá","Caicedo","Caldas","Campamento","Caracolí","Caramanta","Carepa","Carolina del Príncipe","Caucasia","Cañasgordas","Chigorodó","Cisneros","Ciudad Bolivar","Cocomá","Concepción","Concordia","Copacabana","Cáceres","Dabeiba","Donmatías","Ebéjico","El Bagre","El Carmen de Viboral","El Peñol","El Retio","El Santuario","Entrerríos","Envigado","Fredonia","Frontino","Giraldo","Girardota","Granada","Guadalupe","Guarne","Guatapé","Gómez Plata","Heliconia","Hispania","Itagüí","Ituango","Jardín","Jericó","La Ceja","La Estrella","La Pintada","La Unión","Liborina","Maceo","Marinilla","Medellín","Montebello","Murindó","Mutatá","Nechí","Necoclí","Olaya","Peque","Pueblorrico","Puerto Berrío","Puerto Nare","Puerto Triunfo","Remedios","Rionegro","Sabanalarga","Sabaneta","Salgar","San Andrés de Cuerquia","San Carlos","San Francisco","San Jerónimo","San José de la Montaña","San Juan de Urabá","San Luis","San Pedro de los Milagros","San Pedro de Urabá","San Rafael","San Rogue","San Vicente","Santa Bárbara","Santa Fe de Antioquia","Santa Rosa de Osos","Santo Domingo","Segovia","Sonsón","Sopetrán","Tarazá","Tarso","Titiribí","Toledo","Turbo","Támesis","Uramita","Urrao","Valdivia","Valparaíso","Vegachí","Venecia","Vigía del Fuerte","Yalí","Yarumal","Yolombó","Yondó","Zaragoza"]
Amazonas=["El Ecanto","La Chorrera","La Pedrera","La Victoria","Leticia","Mirití-Paraná","Puerto Alegría","Puerto Arica","Puerto Nariño","Puerto Santander","Tarapacá"]
Arauca=["Arauca","Arauquita","Cravo Norte","Fortul","Puerto Rondón","Saravena","Tame"]
Atlantico=["Baranoa","Barranquilla","Campo de la Cruz","Candelaria","Galapa","Juan de Acosta","Luruaco","Malambo","Manatí","Palmar de Varela","Piojó","Polonuevo","Ponedera","Puerto Colombia","Repelón","Sabanalarga","Sanagrande","Santa Lucía","Santo Tomás","Soledad","Suan","Tubará","Usiacurí"]
Bolivar=["Achí","Altos del Rosario" ,"Arenal","Arenal" ,"Arjona" ,"Arroyohondo" ,"Barranco de Loba","Calamar" ,"Cantagallo" ,"Cartagena de Indias","Cicuco","Clemencia","Córdoba","El Carmen de Bolívar" ,"El Guamo","El Peñón","Hatillo de Loba" ,"Magangué" ,"Mahates" ,"Margarita" ,"María La Baja" ,"Montecristo","Morales" ,"Norosí" ,"Pinillos","Puerto Rico","Río Viejo","San Cristóbal","San Fernando","San Jacinto","San Jacinto del Cauca","San Juan Nepomuceno","San Martín de Loba","San Pablo","Santa Catalina","Santa Cruz de Mompox","Santa Rosa","Santa Rosa del Sur","Simití","Soplaviento","Talaigua Nuevo","Turbaco","Turbaná","Villanueva","Zambrano"]
Boyaca=["Chíquiza","Chivatá","Cómbita"	,"Cucaita","Motavita","Oicatá","Samacá","Siachoque","Sora","Soracá","Sotaquirá","Toca","Tunja","Tuta","Ventaquemada","Chiscas","El Cocuy","El Espino","Guacamayas","Güicán","Panqueba","Labranzagrande","Pajarito","Paya","Pisba","Berbeo","Campohermoso","Miraflores","Páez","San Eduardo","Zetaquira","Boyacá","Ciénega","Jenesano","Nuevo Colón","Ramiriquí","Rondón","Tibaná","Turmequé","Úmbita","Viracachá","Chinavita","Garagoa","Macanal","Pachavita","San Luis de Gaceno","Santa María","Boavita","Covarachía","La Uvita","San Mateo","Sativanorte","Sativasur","Soatá","Susacón","Tipacoque","Briceño","Buenavista","Caldas","Chiquinquirá","Coper","La Victoria","Maripí","Muzo","Otanche","Pauna","Quípama","Saboyá","San Miguel de Sema","San Pablo de Borbur","Tununguá","Almeida","Chivor","Guateque","Guayatá","La Capilla","Somondoco","Sutatenza","Tenza","Arcabuco","Chitaraque","Gachantivá","Moniquirá","Ráquira","Sáchica","San José de Pare","Santa Sofía","Santana","Sutamarchán","Tinjacá","Togüí","Villa de Leyva","Aquitania","Cuítiva","Firavitoba","Gámeza","Iza","Mongua","Monguí","Nobsa","Pesca","Sogamoso","Tibasosa","Tópag","Tota","Belén","Busbanzá","Cerinza","Corrales","Duitama","Floresta","Paipa","Santa Rosa de Viterbo","Tutazá","Betéitiva","Chita","Jericó","Paz de Río","Socha","Socotá","Tasco","Cubará","Puerto Boyacá"]
...
Caqueta=["Albania","Belén de los Andaquíes","Cartagena del Chaira","Curillo","Doncello","Paujíl","Florencia","La Montañita","Milán","Morelia","Puerto Rico","San José del Fragua","San Vicente del Caguan","Solano","Solita","Valparaiso"]
...
Cauca=["Almaguer","Argelia","Balboa","Bolívar","Buenos Aires","Caldono","Caloto","Corinto","El Tambo","Florencia","Guachené","Guapi","Inzá","Jambaló","La Sierra","La Vega","López de Micay","Mercaderes","Miranda","Morales","Padilla","Patía","Piamonte","Piendamó","Popayán","Puerto Tejada","Puracé-Coconuco","Páez","Rosas","San Sebastían","Santa Rosa","Santander de Quilichao","Silvia","Soltará","Sucre","Suárez","Timbiquí","Timbío","Toribío","Totoró","Villa Rica"]
...
Cundinamarca=["Agua de Dios","Albán","Anapoima","Anolaima","Apulo","Arbeláez","Beltrán","Bituima","Bojacá","Cabrera","Cachipay","Cajicá","Caparrapí","Carmen de Carupa","Chaguaní","Chipaque","Choachí","Chocontá","Chía","Cogua","Cota","Cucunubá","Cáqueza","El Colegio","El Peñón","El Rosal","Facatativá","Fosca","Funza","Fusagasugá","Fómeque","Fúquene","Gachalá","Gachancipá","Gachetá","Gama","Girardot","Granada","Guachetá","Guaduas","Guasca","Guataquí","Guatavita","Guayabal de Síquima","Guayabetal","Gutiérrez","Jerusalén","Junín" ,"La Calera","La Mesa","La Palma","La Peña","La Vega","Lenguazaque","Machetá","Madrid","Manta","Medina","Mosquera","Nariño","Nemocón","Nilo","Nimaima","Nocaima","Pacho","Paime","Pandi","Paratebueno","Pasca","Puerto Salgar","Pulí","Quebradanegra","Quetame","Quipile","Ricaurte","San Antonio del Tequendama","San Bernardo","San Cayetano","San Francisco de Sales","San Juan de Rioseco","Sasaima","Sesquilé","Sibaté","Silvania","Simijaca","Soacha","Sopó","Subachoque","Suesca","Supatá","Susa","Sutatausa","Tabio","Tausa","Tena","Tenjo","Tibacuy","Tibirita","Tocaima","Tocancipá","Topaipí","Ubalá","Ubaque","Ubaté","Une","Venecia","Vergara","Vianí","Villagómez","Villapinzon","Villeta","Viotá","Yacopí","Zipacón","Zipaquirá","Útica"]
Guainia=["Barrancominas","Cacahual","Inírida","La Guadalupe","Morichal Nuevo","Pana Pana","Puerto Colombia","San Felipe"]
...
La_Guajira=["Albania","Barrancas","Dibulla","Distracción","El Molino","Fonseca","Hatonuevo","La Jagua del Pilar","Maicao","Manaure","Riohacha","San Juan del Cesar","Uribia","Urumita","Villanueva"	]
...
Meta=["Acacías","Barranca de Upía","Cabuyaro","Castilla La Nueva","Cubarral","Cumaral Piedemonte","El Calvario","El Castillo","El Dorado","Fuente de Oro","Granada Ariari","Guamal Piedemonte","La Macarena","La Uribe","Lejanías","Mapiripán","Mesetas Ariari","Puerto Concordia","Puerto Gaitán","Puerto Lleras","Puerto López","Puerto Rico","Restrepo","San Carlos de Guaroa","San Juan de Arama","San Juanito","San Martín","Villavicencio","Vista Hermosa"]
Narino=["Barbacoas","El Charco","Francisco Pizarro","La Tola","Magüí-Payán","Mosquera" ,"Olaya Herrera","Payán","Santa Bárbara ","Tumaco","Aldana","Contadero" ,"Córdoba" ,"Cuaspud" ,"Cumbal" ,"Funes" ,"Guachucal" ,"Gualmatán" ,"Iles","Ipiales","Potosí" ,"puerres","Pupiales" ,"Albán","Arboleda" ,"Belén" ,"Colón","El Rosario","El Tablón de Gómez" ,"La Cruz" ,"La Unión" ,"Leiva" ,"Policarpa" ,"San Bernardo","San Lorenzo","San Pablo" ,"San Pedro de Cartago" ,"Taminango" ,"Buesaco" ,"Chachagüí" ,"Consaca" ,"El Peñol" ,"El Tambo" ,"La Florida","Nariño","San Juan de Pasto","Sandoná" ,"Tangua" ,"Yacuanquer" ,"Ancuya" ,"Cumbitara" ,"Guaitarilla","Imués" ,"La Llanada" ,"Linares" ,"Los Andes-Sotomayor" ,"Mallama" ,"Ospina" ,"Providencia" ,"Ricaurte" ,"Samaniego","Santacruz","Túquerres"]
Norte_de_Santander=["Arboledas","Bochalema","Chitagá","Convención","Cucutilla","Cáchira","Cácota","Cúcuta","Durania","El Carmen","El Tarra","El Zulia","Gramalote","Hacarí","Herrán","La Esperanza","La Playa de Belén","Labateca","Los Patios","Lourdes","Mutiscua","Ocaña","Pamplona","Pamplonita","Puerto Santander","Ragonvalia","Salazar de Las Palmas","San Calixto","San Cayetano","Santiago","Santo Domingo de Silos","Sardinata","Teorama","Tibú","Toledo","Villa Caro","Villa del Rosario","Ábrego"]
...
Risaralda=["Apía","Balboa","Belén de Umbría","Dosquebradas","Guática","La Celia","La Virginia","Marsella","Mistrató","Pereira","Pueblo Rico","Quinchía","Santa Rosa de Cabal"]
San_Andres_Providencia_y_Santa_Catalina=["San Andrés","Providencia","Santa Catalina","Cayos"]
...
Sucre=["Guaranda","Majagual","Sucre","Colosó","Morroa","Ovejas","Coveñas","Palmito","San Onofre","Santiago de Tolú","Toluviejo","Buenavista","Corozal","El Roble","Galeras","Los Palmitos","Sampués","San Juan de Betulia","San Pedro","Sincé","Caimito","La Unión","San Benito Abad","San Marcos"]
...
Valle_del_Cauca=["Alcalá","Andalucía","Ansermanuevo","Argelia","Bolívar","Buenaventura","Buga","Bugalagrande","Caicedonia","Cali","Darién","Candelaria","Cartago" ,"Dagua","Águila","El Cairo","El Cerrito","El Dovio" ,"Florida","Ginebra","Guacari","Jamundí","La Cumbre","La Unión","La Victoria","Obando","Palmira","Pradera","Restrepo","Riofrío","Roldanillo","San Pedro","Sevilla","Toro","Trujillo" ,"Tuluá","Ulloa","Versalles","Vijes","Yotoco","Yumbo","Zarzal" ]	
Vaupes=["Carurú","Mitú","Pacoa","Papunaua","Taraira","Yavaraté"]
